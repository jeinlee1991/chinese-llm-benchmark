...
- 目前已囊括325个大模型，覆盖chatgpt、gpt-5.1、o4-mini、谷歌gemini-3-pro、Claude-4.5、文心ERNIE-X1.1、ERNIE-5.0-Thinking、qwen3-max、百川、讯飞星火、商汤senseChat等商用模型，
...
# 最近评测更新
- [2025/12/5] v5.8.5版本
  - 新增大模型：qwen3-next-80b-a3b-thinking、mistral-large-2512
- [2025/12/3] v5.8.4版本
