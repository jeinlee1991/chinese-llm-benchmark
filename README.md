...
- 目前已囊括335个大模型，覆盖chatgpt、gpt-5.2、o4-mini、谷歌gemini-3-pro、Claude-4.5、文心ERNIE-X1.1、ERNIE-5.0-Thinking、qwen3-max、百川、讯飞星火、商汤senseChat等商用模型，
...
# 最近评测更新
- [2025/12/13] v5.8.6版本
  - 新增大模型：gpt-5.2、qwen-plus-2025-12-01、qwen-plus-think-2025-12-01
...
- [每周最新模型](每周最新模型.md)
    ...
    - [11月17~11月23](每周最新模型.md#11月1711月23)
