...
- [2025/9/1] v5.0版本
  ...
  - 新增“表格总结”评测集，属于“推理与数学计算”领域，详见[表格总结排行榜](leaderboard/表格总结.md)<br>
