...
- 目前已囊括278个大模型，覆盖chatgpt、gpt-4.1、o4-mini、谷歌gemini-2.5、Claude4、智谱GLM-Z1、文心一言、qwen-max、百川、讯飞星火、商汤senseChat、minimax等商用模型，
...
# 最近更新
- [2025/7/29] v4.7版本
  - 新增多个大模型：GLM4.5系列、Qwen3-nothink系列（关闭思考）
- [2025/7/26] v4.6版本
