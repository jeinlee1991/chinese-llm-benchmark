...
- 目前已囊括315个大模型，覆盖chatgpt、gpt-5.1、o4-mini、谷歌gemini-2.5、Claude-4.5、智谱GLM-4.6、文心一言、qwen3-max、百川、讯飞星火、商汤senseChat、minimax等商用模型，
...
# 最近评测更新
- [2025/11/26] v5.8.3版本
  - 新增大模型：gpt-5.1-high、claude-sonnet-4.5、claude-sonnet-4.5-thinking
- [2025/11/22] v5.8.2版本
